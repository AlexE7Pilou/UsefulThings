...
public class SteelBoat extends EntityBoat
{
    ...
    public SteelBoat(World worldIn)
    {
        super(worldIn);
 ...
 @Override
    ...
    public SteelBoat(World worldIn, double p_i1705_2_, double p_i1705_4_, double p_i1705_6_)
    {
        this(worldIn);
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (int k1 = 0; k1 < list.size(); ++k1)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof SteelBoat)
                        {
