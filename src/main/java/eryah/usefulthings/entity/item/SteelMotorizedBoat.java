...
public class SteelMotorizedBoat extends EntityBoat
{
    ...
    public SteelMotorizedBoat(World worldIn)
    {
        super(worldIn);
 ...
 @Override
    ...
    public SteelMotorizedBoat(World worldIn, double p_i1705_2_, double p_i1705_4_, double p_i1705_6_)
    {
        this(worldIn);
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            else
            {
                ...
                if (flag || this.getDamageTaken() > 40.0F)
                {
                    ...
                    if (!flag)
                    {
                        this.dropItemWithOffset(ISteelBoat.steel_boat, 1, 0.0F);
                    }
    ...
    public void func_180426_a(double p_180426_1_, double p_180426_3_, double p_180426_5_, float p_180426_7_, float p_180426_8_, int p_180426_9_, boolean p_180426_10_)
    {
        if (p_180426_10_ && this.riddenByEntity != null)
        {
            ...
            this.motionX = this.velocityX = 0.03D;
            this.motionY = this.velocityY = 0.0D;
            this.motionZ = this.velocityZ = 0.03D;
        }
        else
        {
            if (this.isBoatEmpty)
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (int k1 = 0; k1 < list.size(); ++k1)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof SteelMotorizedBoat)
                        {
