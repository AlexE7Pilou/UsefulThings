...
public class IReinforcedBoat extends Item
{
    private static final String __OBFID = "CL_00001774";
    public static Item reinforced_boat;

    public IReinforcedBoat()
    {
        this.maxStackSize = 1;
    }
    ...
    public static void init(){
    	reinforced_boat = new IReinforcedBoat().setUnlocalizedName("reinforced_boat").setCreativeTab(UsefulthingsMod.UTTab);
	}
	
	public static void register()
	{
		GameRegistry.registerItem(reinforced_boat, reinforced_boat.getUnlocalizedName().substring(5));
	}
	
	public static void registerRenders()
	{
		registerRender(reinforced_boat);
	}
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    ReinforcedBoat boat = new ReinforcedBoat(worldIn, (double)((float)blockpos.getX() + 0.5F), (double)((float)blockpos.getY() + 1.0F), (double)((float)blockpos.getZ() + 0.5F));
