...
public class BladedBowDiamond extends ItemBow
{ 
    public static Item diamond_bladed_bow;
    private float attackDamage;

    public BladedBowDiamond()
    {
        this.maxStackSize = 1;
	...
	public static void init(){
		diamond_bladed_bow = new BladedBowDiamond().setUnlocalizedName("diamond_bladed_bow").setCreativeTab(UsefulthingsMod.UTTab);
	}
	
	public static void register()
	{
		GameRegistry.registerItem(diamond_bladed_bow, diamond_bladed_bow.getUnlocalizedName().substring(5));
	}
	
	public static void registerRenders()
	{
		registerRender(diamond_bladed_bow);
	}
   ...
   public Set<String> getToolClasses(ItemStack stack) {
        return ImmutableSet.of("bow", "sword");
    }
