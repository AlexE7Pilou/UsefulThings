...
public class IIronMotorizedBoat extends Item
{
    private static final String __OBFID = "CL_00001774";
    public static Item iron_motorized_boat;

    public IIronMotorizedBoat()
    {
        this.maxStackSize = 1;
    }
    ...
    public static void init(){
    	iron_motorized_boat = new IIronMotorizedBoat().setUnlocalizedName("iron_motorized_boat").setCreativeTab(UsefulthingsMod.UTTab);
	}
	
	public static void register()
	{
		GameRegistry.registerItem(iron_motorized_boat, iron_motorized_boat.getUnlocalizedName().substring(5));
	}
	
	public static void registerRenders()
	{
		registerRender(iron_motorized_boat);
	}
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    IronMotorizedBoat motoboat = new IronMotorizedBoat(worldIn, (double)((float)blockpos.getX() + 0.5F), (double)((float)blockpos.getY() + 1.0F), (double)((float)blockpos.getZ() + 0.5F));
