...
public class RenderSteelMotoBoat extends RenderBoat
{
    private static final ResourceLocation boatTextures = new ResourceLocation("ut:textures/entity/steelmotoboat.png");
    /** instance of ModelBoat for rendering */
    protected ModelBase modelBoat = new ModelMotoBoat();

    public RenderSteelMotoBoat(RenderManager render, ModelMotoBoat model, float shadow)
    {
        super(Minecraft.getMinecraft().getRenderManager());
        this.shadowSize = 0.5F;
    }

    public void doRender(SteelMotorizedBoat entity, double p_180552_2_, double p_180552_4_, double p_180552_6_, float p_180552_8_, float p_180552_9_)
    {
    ...
    protected ResourceLocation getEntityTexture(SteelMotorizedBoat p_180553_1_)
    {
        return boatTextures;
    }
    ...
    {
        return this.getEntityTexture((SteelMotorizedBoat)entity);
    }
    ...
    {
        this.doRender((SteelMotorizedBoat)entity, x, y, z, p_76986_8_, partialTicks);
    }
}