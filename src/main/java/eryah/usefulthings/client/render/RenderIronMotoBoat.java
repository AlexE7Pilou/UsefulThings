...
public class RenderIronMotoBoat extends RenderBoat
{
    private static final ResourceLocation boatTextures = new ResourceLocation("ut:textures/entity/ironmotoboat.png");
    /** instance of ModelBoat for rendering */
    protected ModelBase modelBoat = new ModelMotoBoat();

    public RenderIronMotoBoat(RenderManager render, ModelMotoBoat model, float shadow)
    {
        super(Minecraft.getMinecraft().getRenderManager());
        this.shadowSize = 0.5F;
    }

    public void doRender(IronMotorizedBoat entity, double p_180552_2_, double p_180552_4_, double p_180552_6_, float p_180552_8_, float p_180552_9_)
    {
    ...
    protected ResourceLocation getEntityTexture(IronMotorizedBoat p_180553_1_)
    {
        return boatTextures;
    }
    ...
    {
        return this.getEntityTexture((IronMotorizedBoat)entity);
    }
    ...
    {
        this.doRender((IronMotorizedBoat)entity, x, y, z, p_76986_8_, partialTicks);
    }
}