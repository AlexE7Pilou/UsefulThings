...
public class LitCrusher extends BlockContainer {

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
    private static boolean isBurning;
    private static boolean keepInventory;
    private static final String __OBFID = "CL_00000248";
    public static Block lit_crusher;

    protected LitCrusher(Material mat, boolean isBurning)
    {
        super(Material.rock);
	...
	public static void init()
		{
		 lit_crusher = new LitCrusher(Material.rock, isBurning).setUnlocalizedName("lit_crusher");
		}
		
		public static void register()
		{
			GameRegistry.registerBlock(lit_crusher, lit_crusher.getUnlocalizedName().substring(5));
		}
		
		public static void registerRenders()
		{
			registerRender(lit_crusher);
		}
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        if (this.isBurning)
        {
            ...
            switch (LitCrusher.SwitchEnumFacing.FACING_LOOKUP[enumfacing.ordinal()])
            {
                case 1:
    ...
    {
        return Item.getItemFromBlock(LitCrusher.lit_crusher);
    }
