...
public class WeaponTableRecipes
{
    /** The static instance of this class */
    private static final WeaponTableRecipes instance = new WeaponTableRecipes();
     ...
     */
    public static WeaponTableRecipes getInstance()
    {
        /** The static instance of this class */
        return instance;
    }

    private WeaponTableRecipes()
    {   
        this.addRecipe(new ItemStack(MakeshiftRifle.makeshift_rifle), new Object[] {"IS ", "SIF", " IB", 'I', Items.iron_ingot, 'S', Items.string, 'F', Items.flint, 'B', Blocks.planks}); 
