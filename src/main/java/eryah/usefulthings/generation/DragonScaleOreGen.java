...
public class DragonScaleOreGen implements IWorldGenerator {
	...
	public DragonScaleOreGen() {
		...
		this.dragon_scale_ore = new WorldGenMinable(DragonScaleOre.dragon_scale_ore.getDefaultState(), 6);
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
		...
		case 0: // Overworld
			this.runGenerator(this.dragon_scale_ore, world, random, chunkX, chunkZ, 2, 0, 12);
			break;
		case -1: // Nether
